...
use crate::clients::ics10_stellar::header::Header;
use crate::clients::ics10_stellar::raw;
use crate::core::ics24_host::identifier::ClientId;
use crate::tx_msg::Msg;
use crate::Height;

pub const STELLAR_MISBEHAVIOUR_TYPE_URL: &str = "/ibc.lightclients.stellar.v1.Misbehaviour";
...
impl Msg for Misbehaviour {
    ...
    fn type_url(&self) -> String {
        STELLAR_MISBEHAVIOUR_TYPE_URL.to_string()
    }
}
...
impl TryFrom<RawMisbehaviour> for Misbehaviour {
    ...
    fn try_from(raw: RawMisbehaviour) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            header1: raw
                .header_1
                .ok_or_else(|| Error::missing_field("header_1"))?
                .try_into()?,
            header2: raw
                .header_2
                .ok_or_else(|| Error::missing_field("header_2"))?
                .try_into()?,
        })
    }
}
