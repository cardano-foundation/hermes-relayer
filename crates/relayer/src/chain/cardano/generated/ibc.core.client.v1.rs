...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct QueryNewClientRequest {
    /// Block number to query
    #[prost(uint64, tag = "1")]
    pub height: u64,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct QueryNewClientResponse {
    /// client state associated with the request identifier
    #[prost(message, optional, tag = "1")]
    pub client_state: ::core::option::Option<::prost_types::Any>,
    /// consensus state associated with the request identifier
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct QueryBlockDataResponse {
    /// block data associated with the request identifier
    #[prost(message, optional, tag = "1")]
    pub block_data: ::core::option::Option<::prost_types::Any>,
}
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ibc.core.client.v1.Query", "LatestHeight"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn new_client(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryNewClientRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryNewClientResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ibc.core.client.v1.Query/NewClient",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ibc.core.client.v1.Query", "NewClient"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn block_data(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryBlockDataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryBlockDataResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ibc.core.client.v1.Query/BlockData",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ibc.core.client.v1.Query", "BlockData"));
            self.inner.unary(req, path, codec).await
        }
    }
}
